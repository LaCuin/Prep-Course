...
if (nvoArray.includes ("Enero")  && nvoArray.includes("Marzo")  && nvoArray.includes("Noviembre")){
  return nvoArray
}
...
function mayorACien(array) {
  ...
  // Tu código:
  // array [0 al 200]
  // recorra el array y retorne los valores mayores a 100
...
if (nvoValor.length <10){
  return "Se interrumpió la ejecución"
}
else if (nvoValor.length === 10){
  return nvoValor;
}
}
